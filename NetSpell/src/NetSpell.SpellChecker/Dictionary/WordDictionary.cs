...
namespace NetSpell.SpellChecker.Dictionary {
    ...
    public class WordDictionary : Component {
        ...
        private void LoadUserFile() {
            ...
            if (!this.EnableUserFile) {
                return;
            }

            string userPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "NetSpell");
        ...
        public bool Contains(string word) {
            ...
            foreach (AffixRule rule in this.SuffixRules.Values) {
        ...
        public ArrayList ExpandWord(Word word) {
            ...
            string prefixKeys = string.Empty;
        ...
        public void Initialize() {
            ...
            TraceWriter.TraceInfo(
                            "Dictionary Loaded BaseWords:{0}; PrefixRules:{1}; SuffixRules:{2}; PhoneticRules:{3}",
                            this.BaseWords.Count,
                            this.PrefixRules.Count,
                            this.SuffixRules.Count,
                            this.PhoneticRules.Count);
        ...
        /// <summary>
        /// Gets a value indicating whether the dictionary has been initialized.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        internal ArrayList PossibleBaseWords {
            get { return this._possibleBaseWords; }
        }
