...
namespace NetSpell.SpellChecker.Controls {
    ...
    public class SpellTextBox : System.Windows.Forms.RichTextBox {
        ...
        private void MarkMisspelledWords(int startWordIndex, int endWordIndex) {
            ...
            int eventMask = NativeMethods.SendMessage(this.Handle, NativeMethods.EM_SETEVENTMASK, 0, 0);

            // optimize by disabling redraw
            NativeMethods.SendMessage(base.Handle, NativeMethods.WM_SETREDRAW, 0, 0);
            ...
            eventMask = NativeMethods.SendMessage(this.Handle, NativeMethods.EM_SETEVENTMASK, 0, eventMask);
            // restore redraw
            NativeMethods.SendMessage(base.Handle, NativeMethods.WM_SETREDRAW, 1, 0);
        }
    }
}
